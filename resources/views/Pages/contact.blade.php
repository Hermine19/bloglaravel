        ...
        <div class="container">
            <div class="row">
                <div class="col-md-7 mb-5">
                    ...
                    <form action="{{route('contact')}}" class="p-5 bg-white" method="POST">
                        @csrf
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="email" id="email" class="form-control" name="mail" value="{{old('mail')}}">
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="subject" id="subject" class="form-control" name="sub" value="{{old('sub')}}">
                            </div>
                        </div>
