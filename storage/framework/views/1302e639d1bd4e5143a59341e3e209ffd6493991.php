                ...
                <div class="col-lg-4 mb-4">
                    <div class="entry2">
                        ...
                        <div class="excerpt">
                            ...
                            <h2><a href="<?php echo e(url("/post/{$post->id}")); ?>"><?php echo e($post->title); ?></a></h2>
                            <div class="post-meta align-items-center text-left clearfix">
                                ...
                                <span class="d-inline-block mt-1">By <a href="<?php echo e(url('/userposts/'.$post->user_id)); ?>"><?php echo e($post->user->name); ?></a></span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TravelAlone\resources\views/Pages/cat.blade.php ENDPATH**/ ?>